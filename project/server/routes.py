...
def update_administrador(id_administrador):
    ...
    administrador.id_personal = datos.get('id_personal', administrador.id_personal)
    administrador.id_torneig = datos.get('id_torneig', administrador.id_torneig)
    db.session.commit()
    return jsonify(administrador.serialize())
...
def delete_administrador(id_administrador):
    ...
    db.session.commit()
    return jsonify({"message": "Administrador eliminat correctament"})
